namespace VisionNet.DataType
{
    ...
    public class CxMesh
    {
        ...
        /// <summary>Gets or sets per-vertex difference values (float, may be negative) used by
        /// <c>SurfaceColorMode.Diff</c>, or <c>null</c> if differential coloring is not used.</summary>
